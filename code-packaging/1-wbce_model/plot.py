...
def plot_f1(logs):
    ...
    def plot_train():
        ...
        plt.savefig('./plot_result/shallow_train_f1.png', dpi=150)
        plt.close()
    def plot_val():
        plt.rcParams["figure.figsize"] = (16,4)
        plt.rcParams['lines.linewidth'] = 2
        ...
        plt.xlabel('epoch', fontsize=15)
        plt.ylabel('f1', fontsize=15)
        plt.savefig('./plot_result/shallow_val_f1.png', dpi=150)
        plt.close()
    plot_train()
    plot_val()
...
def plot_loss(logs):
    ...
    def plot_train():
        ...
        plt.savefig('./plot_result/shallow_train_loss.png', dpi=150)
        plt.close()
    def plot_val():
        plt.rcParams["figure.figsize"] = (16,4)
        plt.rcParams['lines.linewidth'] = 2
        ...
        plt.xlabel('epoch', fontsize=15)
        plt.ylabel('loss', fontsize=15)
        plt.savefig('./plot_result/shallow_val_loss.png', dpi=150)
        plt.close()
    plot_train()
    plot_val()
...
if __name__ == "__main__":
    logs = {}
    logs["2_max_pooling"] = "./log/12-15_16-27_weighted_BCE"
    logs["3_max_pooling"] = "./log/12-15_19-42_weighted_BCE"
    logs["original"] = "./log/12-16_00-32_weighted_BCE"
    plot_f1(logs)
    plot_loss(logs)

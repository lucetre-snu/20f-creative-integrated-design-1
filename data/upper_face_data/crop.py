...
if __name__ == "__main__":
    main("../new_data/train/", "../new_data/train/", "./train/", 0, 1248, 0, 320)
    main("../new_data/test/", "../new_data/test/", "./test/", 0, 1248, 0, 320)
    main("../new_data/val/", "../new_data/val/", "./val/", 0, 1248, 0, 320)
